...
const CategoryTypesContext = createContext<any>(INITIAL_STATE);

export const CategoryTypesProvider: React.FC<any> = ({ children }) => {
  ...
  const [CategoryTypesTypeId, setCategoryTypesTypeId] = useState(null);
  ...
  return (
    <CategoryTypesContext.Provider
      value={{
        ...
        CategoryTypesTypeId, setCategoryTypesTypeId,
...
export default CategoryTypesContext;
