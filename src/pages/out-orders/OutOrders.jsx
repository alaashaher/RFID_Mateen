...
const OrderForm = ({ initial, assetTypes, camps = [], campManagers = [], onSave, onCancel }) => {
  ...
  <div style={{
    ...
    <select
      ...
      style={{ border: "none", outline: "none", fontSize: 13, direction: "rtl",
      ...
      <div style={{ background: "#F7F8FA", borderRadius: 10, padding: 16, marginBottom: 20 }}>
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, direction: "rtl" }}>
            ...
            <tbody>{form.Items.map((item, idx) => { const typeObj = assetTypes.find(t => String(t.AssetTypeId) === String(item.AssetTypeId)); const hasModels = typeObj?.hasModels; const models = modelMap[item.AssetTypeId] || [];
